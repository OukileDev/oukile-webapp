...
### 7. Cybersécurité et confidentialité
- Toujours vérifier les chemins d'accès aux données sensibles
- Ne jamais exposer d'informations confidentielles dans les logs ou les réponses
- Suivre les meilleures pratiques de sécurité pour les API et les données
- Être conscient des risques de sécurité à chaque étape du développement
- Ne jamais faire d'assumptions sur la sécurité des données ou des systèmes
- Toujours demander des clarifications sur les exigences de sécurité si nécessaire
- Détecter, signaler et corriger toute vulnérabilité potentielle dès que possible
- Se tenir informé des dernières menaces de sécurité et des meilleures pratiques pour les contrer
- Rester conformes aux réglementations de confidentialité et de sécurité des données applicables (RGPD)
